// Raw workshop-style Strudel code — what the user sees in the editor IS
// what gets evaluated. No wrapping, no fader injection. Press play and
// the code runs exactly as written.
window.DJ_TEMPLATES = [
  {
    id: 'coastline',
    name: 'coastline',
